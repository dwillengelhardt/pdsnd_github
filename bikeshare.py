...
def load_data(city, month, day):
    """
    Loads data for the specified city and filters based on the user's previous inputs.
...
def user_stats(df):
    """
    Displays statistics on bikeshare users for user type, gender (if available) and 
